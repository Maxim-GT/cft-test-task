...
export function CheckOtpForm(props: ICheckOtpFormProps): JSX.Element {
    const { form, onSubmit, onResend, isLoading, secondsLeft, canResend } = useCheckOtp(props);
        ...
        <form onSubmit={onSubmit} noValidate>
            ...
            <div className={styles.actions}>
                <Button
                    type="submit"
                    disabled={isLoading}
                    aria-label={isLoading ? 'Выполняется вход, подождите' : 'Войти'}
                >
                ...
                {!canResend ? (
                    ...
                    <Button
                        ...
                        aria-label="Запросить код еще раз"
                    >
